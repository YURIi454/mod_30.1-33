...
class TestCourseLesson(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.user = CustomUser.objects.create_user(email="test@test.com", username="TesTUser", password="password123")

        self.course = Course.objects.create(name="Test_Course_1", description="Test_Course_1", owner=self.user)
    ...
    def test_create_lesson(self):
        ...
        self.assertEqual(
            response.json(), {"name": "Test_lesson", "description": "Test_lesson", "video": None, "course": 3}
        )
