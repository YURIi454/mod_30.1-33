...
class Payments(models.Model):
    ...
    pay_met_list = [("cache", "наличные"), ("transfer", "перевод"), ("bonuses", "бонусы и акции")]
    ...
    payment_method = models.CharField(choices=pay_met_list, default="transfer", verbose_name="способ оплаты")
